...
public class ProductAttributeValueController {
    ...
    public String manage(@PathVariable Long productId,
                         HttpSession session,
                         Model model) {
        ...
        return "admin/product_attribute_values/product-attribute-values";
    }

    @PostMapping("/products/{productId}/attribute-values/save")
    public String save(@PathVariable Long productId,
        ...
        params.forEach((k, v) -> {
            if (k.startsWith("attrId_")) {
                ...
                String boolStr = params.get("bool_" + idx);
                ...
                requests.add(new ProductAttributeValueRequest(
                        attributeId,
                        valueText,
                        valueNumber,
                        valueBoolean
